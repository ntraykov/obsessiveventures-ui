<template>
    ...
    >
      <div class="text-sm">
        Този сайт използва бисквитки, за да подобри вашето изживяване. За повече информация
        вижте нашата
        <NuxtLink to="/politika-za-biskvitki" class="underline text-green-400 hover:text-green-300">
